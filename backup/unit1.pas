...
type
  ...
  TForm1 = class(TForm)
      ...
      TimeEdit1: TTimeEdit;
      TimeEdit2: TTimeEdit;
      procedure butt(Sender: TObject; var CloseAction: TCloseAction);
...
begin
  ...
  try
    ...
    stringTekstAwarii.Replace(',','.');
    stringOperatorZglaszajacy := ComboBox4.Text;
    stringOperatorZglaszajacy.Replace(',','.');
...
procedure TForm1.butt(Sender: TObject; var CloseAction: TCloseAction);   //przy zamknieciu programu ma zapisać do ini
begin
  button11.Click;
end;
